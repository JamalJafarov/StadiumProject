        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stads_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationToCustomers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationToCustomers_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationToCustomers_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationToStadiums", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationToStadiums_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationToStadiums_Stads_StadiumId",
                        column: x => x.StadiumId,
                        principalTable: "Stads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationToCustomers_CustomerId",
                table: "ReservationToCustomers",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationToCustomers_ReservationId",
                table: "ReservationToCustomers",
                column: "ReservationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationToStadiums_ReservationId",
                table: "ReservationToStadiums",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationToStadiums_StadiumId",
                table: "ReservationToStadiums",
                column: "StadiumId");
